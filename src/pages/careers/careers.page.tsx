...
import {
  ...
  TextSubTitle,
  TextTitle,
} from "../../components/main-layout/text-content/text-content.styles";
  ...
  return (
    <>
      ...
      <Section mainContent>
        ...
        <TextDescription>
          Our <TextSubTitle>‘Stay at Home’</TextSubTitle> policy is integral to our sustainability programme. We
